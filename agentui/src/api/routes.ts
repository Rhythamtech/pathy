export const APIRoutes = {
  ...
  Status: (agentOSUrl: string) => `${agentOSUrl}/status`,
  ...
  ConfigGet: (agentOSUrl: string) => `${agentOSUrl}/api/config`,
  ConfigSet: (agentOSUrl: string) => `${agentOSUrl}/api/config`,
  ConfigClear: (agentOSUrl: string) => `${agentOSUrl}/api/config`
}
