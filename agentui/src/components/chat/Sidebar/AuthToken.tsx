      ...
      {isEditing ? (
        <div className="flex w-full items-center gap-1">
          <input
            ...
            className="flex h-9 w-full items-center text-ellipsis rounded-md border border-hairline bg-surface-card p-3 text-xs font-medium text-muted placeholder:text-mute/50"
            autoFocus
          />
          <Button
            variant="ghost"
