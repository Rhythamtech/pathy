...
const SessionBlankState = () => {
  ...
  return (
    <div className="mt-4 flex items-center justify-center border border-hairline bg-surface-soft py-8 px-4 rounded-md">
      <div className="flex flex-col items-center gap-4 text-center">
        <div className="font-mono text-ash text-2xl">-</div>
        <div className="flex flex-col items-center gap-1">
          <h3 className="text-xs font-medium uppercase text-mute">No Session found</h3>
          <p className="max-w-[180px] text-xs text-body leading-relaxed">
            {errorMessage}
          </p>
        </div>
      </div>
