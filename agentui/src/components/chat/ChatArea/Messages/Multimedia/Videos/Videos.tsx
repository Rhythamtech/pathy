    ...
    <div>
      <div className="group relative w-full max-w-xl">
        ...
        <button
          ...
          className="absolute right-2 top-2 flex items-center justify-center rounded-md bg-canvas/80 p-1.5 opacity-0 transition-opacity duration-200 hover:bg-surface-card group-hover:opacity-100"
