...
async def _run_pipeline(requirement: UserRequirement) -> None:
    ...
    if not courses:
        ...
        console.print("[bold red]No eligible creator-led courses were found.[/bold red]")
    ...
    console.print()
    console.print(f"[bold green]Saved roadmap:[/bold green] {markdown_path}")
    console.print(f"[bold green]Saved research JSON:[/bold green] {json_path}")
